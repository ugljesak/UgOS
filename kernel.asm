...
0000000080001000 <_ZN15MemoryAllocator9mem_allocEm>:
...
000000008000101c <_ZN15MemoryAllocator8mem_freeEPv>:
...
int main() {
    ...
    80001040:	00813023          	sd	s0,0(sp)
    80001044:	01010413          	addi	s0,sp,16
    char ch = __getc();
    80001048:	00002097          	auipc	ra,0x2
    8000104c:	140080e7          	jalr	320(ra) # 80003188 <__getc>
    __putc(ch);
    80001050:	00002097          	auipc	ra,0x2
    80001054:	0fc080e7          	jalr	252(ra) # 8000314c <__putc>
    __putc('\n');
    80001058:	00a00513          	li	a0,10
    8000105c:	00002097          	auipc	ra,0x2
    80001060:	0f0080e7          	jalr	240(ra) # 8000314c <__putc>
    void* test = nullptr;
    MemoryAllocator::mem_free(test);
    80001064:	00000513          	li	a0,0
    80001068:	00000097          	auipc	ra,0x0
    8000106c:	fb4080e7          	jalr	-76(ra) # 8000101c <_ZN15MemoryAllocator8mem_freeEPv>

    return 0;
    80001070:	00000513          	li	a0,0
    80001074:	00813083          	ld	ra,8(sp)
    80001078:	00013403          	ld	s0,0(sp)
...
0000000080001210 <system_main>:
    ...
    80001230:	07c48493          	addi	s1,s1,124 # 800042a8 <started>
    ...
    8000124c:	de850513          	addi	a0,a0,-536 # 80004030 <console_handler+0xe70>
    ...
    800012d4:	d4850513          	addi	a0,a0,-696 # 80004018 <console_handler+0xe58>
...
0000000080001338 <userinit>:
    ...
    80001350:	cec30067          	jr	-788(t1) # 80001038 <main>
...
0000000080001354 <either_copyout>:
    ...
    80001394:	cc850513          	addi	a0,a0,-824 # 80004058 <console_handler+0xe98>
...
00000000800013a0 <either_copyin>:
    ...
    800013dc:	ca850513          	addi	a0,a0,-856 # 80004080 <console_handler+0xec0>
...
00000000800013e8 <trapinit>:
    ...
    800013fc:	cb058593          	addi	a1,a1,-848 # 800040a8 <console_handler+0xee8>
...
0000000080001468 <kerneltrap>:
    ...
    80001498:	c5c50513          	addi	a0,a0,-932 # 800040f0 <console_handler+0xf30>
    ...
    800014b0:	c5450513          	addi	a0,a0,-940 # 80004100 <console_handler+0xf40>
    800014b4:	00001097          	auipc	ra,0x1
    800014b8:	874080e7          	jalr	-1932(ra) # 80001d28 <__printf>
    800014bc:	00003517          	auipc	a0,0x3
    800014c0:	c5c50513          	addi	a0,a0,-932 # 80004118 <console_handler+0xf58>
    ...
    80001534:	ba050513          	addi	a0,a0,-1120 # 800040d0 <console_handler+0xf10>
    ...
    80001570:	d4070713          	addi	a4,a4,-704 # 800042ac <ticks>
    ...
    800015a4:	b1050513          	addi	a0,a0,-1264 # 800040b0 <console_handler+0xef0>
...
00000000800015b0 <clockintr>:
    ...
    800015dc:	cd470713          	addi	a4,a4,-812 # 800042ac <ticks>
...
0000000080001608 <devintr>:
    ...
    800016b0:	a2450513          	addi	a0,a0,-1500 # 800040d0 <console_handler+0xf10>
    ...
    800016e4:	bcc70713          	addi	a4,a4,-1076 # 800042ac <ticks>
...
0000000080001c28 <consoleinit>:
    ...
    80001c4c:	4e058593          	addi	a1,a1,1248 # 80004128 <console_handler+0xf68>
...
0000000080001ccc <panic>:
    ...
    80001ce8:	44c50513          	addi	a0,a0,1100 # 80004130 <console_handler+0xf70>
    ...
    80001d0c:	40850513          	addi	a0,a0,1032 # 80004110 <console_handler+0xf50>
    80001d10:	00000097          	auipc	ra,0x0
    80001d14:	018080e7          	jalr	24(ra) # 80001d28 <__printf>
    80001d18:	00100793          	li	a5,1
    80001d1c:	00002717          	auipc	a4,0x2
    80001d20:	58f72a23          	sw	a5,1428(a4) # 800042b0 <panicked>
...
0000000080001d28 <__printf>:
    ...
    80002300:	e3cc8c93          	addi	s9,s9,-452 # 80004138 <console_handler+0xf78>
    ...
    800023b0:	d9450513          	addi	a0,a0,-620 # 80004140 <console_handler+0xf80>
...
00000000800023bc <printfinit>:
    ...
    800023e0:	d7458593          	addi	a1,a1,-652 # 80004150 <console_handler+0xf90>
...
0000000080002448 <uartputc>:
    ...
    8000244c:	e687a783          	lw	a5,-408(a5) # 800042b0 <panicked>
    ...
    80002478:	e4490913          	addi	s2,s2,-444 # 800042b8 <uart_tx_r>
    8000247c:	00093783          	ld	a5,0(s2)
    80002480:	00002497          	auipc	s1,0x2
    80002484:	e4048493          	addi	s1,s1,-448 # 800042c0 <uart_tx_w>
...
0000000080002540 <uartputc_sync>:
    ...
    80002550:	d6472703          	lw	a4,-668(a4) # 800042b0 <panicked>
...
0000000080002584 <uartstart>:
    ...
    80002594:	d2860613          	addi	a2,a2,-728 # 800042b8 <uart_tx_r>
    80002598:	00002517          	auipc	a0,0x2
    8000259c:	d2850513          	addi	a0,a0,-728 # 800042c0 <uart_tx_w>
...
0000000080002630 <uartintr>:
    ...
    80002678:	c4460613          	addi	a2,a2,-956 # 800042b8 <uart_tx_r>
    8000267c:	00002517          	auipc	a0,0x2
    80002680:	c4450513          	addi	a0,a0,-956 # 800042c0 <uart_tx_w>
    ...
    800026e8:	bd460613          	addi	a2,a2,-1068 # 800042b8 <uart_tx_r>
    800026ec:	00002517          	auipc	a0,0x2
    800026f0:	bd450513          	addi	a0,a0,-1068 # 800042c0 <uart_tx_w>
...
0000000080002748 <kinit>:
    ...
    800027ac:	b2090913          	addi	s2,s2,-1248 # 800042c8 <kmem>
...
0000000080002820 <freerange>:
    ...
    80002884:	a4890913          	addi	s2,s2,-1464 # 800042c8 <kmem>
...
0000000080002900 <kfree>:
    ...
    8000294c:	98078793          	addi	a5,a5,-1664 # 800042c8 <kmem>
...
0000000080002980 <kalloc>:
    ...
    80002998:	93478793          	addi	a5,a5,-1740 # 800042c8 <kmem>
...
0000000080003188 <__getc>:
    ...
    800031a8:	ae8080e7          	jalr	-1304(ra) # 80001c8c <console_read>
    800031ac:	fe844503          	lbu	a0,-24(s0)
    800031b0:	01813083          	ld	ra,24(sp)
    800031b4:	01013403          	ld	s0,16(sp)
    800031b8:	02010113          	addi	sp,sp,32
    800031bc:	00008067          	ret

00000000800031c0 <console_handler>:
    ...
    800031dc:	0027f793          	andi	a5,a5,2
    800031e0:	06079e63          	bnez	a5,8000325c <console_handler+0x9c>
    800031e4:	00074c63          	bltz	a4,800031fc <console_handler+0x3c>
    ...
    800031fc:	0ff77713          	andi	a4,a4,255
    80003200:	00900793          	li	a5,9
    80003204:	fef712e3          	bne	a4,a5,800031e8 <console_handler+0x28>
    80003208:	ffffe097          	auipc	ra,0xffffe
    8000320c:	6dc080e7          	jalr	1756(ra) # 800018e4 <plic_claim>
    80003210:	00a00793          	li	a5,10
    80003214:	00050493          	mv	s1,a0
    80003218:	02f50c63          	beq	a0,a5,80003250 <console_handler+0x90>
    8000321c:	fc0506e3          	beqz	a0,800031e8 <console_handler+0x28>
    80003220:	00050593          	mv	a1,a0
    80003224:	00001517          	auipc	a0,0x1
    80003228:	eac50513          	addi	a0,a0,-340 # 800040d0 <console_handler+0xf10>
    8000322c:	fffff097          	auipc	ra,0xfffff
    80003230:	afc080e7          	jalr	-1284(ra) # 80001d28 <__printf>
    ...
    80003248:	ffffe317          	auipc	t1,0xffffe
    8000324c:	6d430067          	jr	1748(t1) # 8000191c <plic_complete>
    80003250:	fffff097          	auipc	ra,0xfffff
    80003254:	3e0080e7          	jalr	992(ra) # 80002630 <uartintr>
    80003258:	fddff06f          	j	80003234 <console_handler+0x74>
    8000325c:	00001517          	auipc	a0,0x1
    80003260:	f7450513          	addi	a0,a0,-140 # 800041d0 <digits+0x78>
    80003264:	fffff097          	auipc	ra,0xfffff
    80003268:	a68080e7          	jalr	-1432(ra) # 80001ccc <panic>
	...
